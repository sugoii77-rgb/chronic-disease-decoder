...
const doctorQuestions = [
  ...
  "공복 인슐린과 HOMA-IR 검사를 받아볼 수 있을까요? 인슐린 저항성을 조기에 확인하고 싶습니다.",
  "HbA1c가 정상이어도 식후 혈당 스파이크가 있을 수 있나요? 식후 혈당 모니터링이 필요할까요?",
  "제 중성지방/HDL 비율이 인슐린 저항성의 간접 신호가 될 수 있나요?",
  "생활습관 개선(식단·운동)으로 당뇨 전단계나 초기 인슐린 저항성을 역전시킬 수 있는 가능성이 있나요?",
  "당뇨약 복용 중에 간헐적 단식이나 저탄수화물 식단을 시도하고 싶은데 어떻게 시작해야 안전한가요?",
];
